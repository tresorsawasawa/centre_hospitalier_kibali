...
import ConsultRegAdmission from '../../components/YourArrival/ConsultRegAdmission';
import './consultations.scss';
import ConsultationsRights from '../../components/YourArrival/ConsultationsRights';
...
const Consultations = () => {
  ...
  const handleClickButton = (index) => {
    ...
    if (index === 0) {
      setResult(<ConsultRegAdmission />);
    } else {
      setResult(<ConsultationsRights />);
    }
  };
  ...
  return (
    <section className="consultations w-full pt-[12rem]">
      <div className="wrapper w-full">
        <div className="headings flex flex-col items-center justify-center gap-[1.5rem] w-full">
          <h2 className="sectionTitle uppercase text-[20px] font-[600] text-[#13c5dd] relative mb-[2rem]">Consultations</h2>
        </div>
          ...
          <table className="border p-[1rem]">
            <tbody>
              ...
              <tr className="resultContainer">
                <td colSpan={2}>
                  {result === null ? <ConsultRegAdmission /> : result}
                </td>
              </tr>
            </tbody>
          </table>
